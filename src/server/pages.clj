                  ...
                  [:div
                   ...
                   [:div
                    ...
                    [:p
                     ...
                     (read-string (:event/title event))]]]
                  [:div
                   {:class "col-xs-12 col-sm-12 col-md-12 col-lg-12"}
                   [:span
                    {}
                    (read-string (:event/description event))]]]))]))
    [:div
     {:class "col-xs-12 col-sm-12 col-md-6 col-lg-6 section"}
     [:div
      {:class "row"}
      ...
      [:div
       ...
       (doall (for [news (db-api/get-news db)]
               [:article
                ...
                [:p
                 {:class "news-heading"}
                 (read-string (:news/title news))]
                [:span
                 {}
                 (read-string (:news/body news))]]))]]]]]])
          ...
          [:div
           ...
           [:div
            ...
            [:a {:href "/unterstuetzung#patenschaft"}
              [:button {:class "button"} "Weitere Infos zur Patenschaft"]]
            [:br {}]
            [:a {:href "/resources/projektbeschreibung.pdf"}
              [:button {:class "button"} "Projektbeschreibung herunterladen"]]]]]]]]
      [:div
       {:class "col-xs-12 col-sm-12 col-md-12 col-lg-12 section"}
       [:div
        {:class "row"}
   ...
   [:div
    ...
    [:div
     ...
     [:a
      {:class
       "section col-sm-4 col-xs-4 col-md-3 col-lg-3 footerelement"
       :href "/rundbriefarchiv"}
      [:span {:class "footerlink"} "Rundbriefarchiv"]]
     [:a
      {:class
       "section col-sm-4 col-xs-4 col-md-3 col-lg-3 footerelement"
       :href "/resources/projektbeschreibung.pdf"}
      [:span {:class "footerlink"} "Projektbeschreibung"]]]
    [:div
     {:class "row"}
     [:div
      {:class
