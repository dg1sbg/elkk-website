...
ENV ELKKWEB_DATOMIC_URI datomic:sql://elkkweb?jdbc:postgresql://postgres:5432/datomic?user=datomic&password=dt619pa7_ie4viydt__
...
CMD dockerize -wait tcp://datomic:4334 -timeout 600s java -jar ${ELKKWEB_LIB_DIR}/${ELKKWEB_JARFILE}
